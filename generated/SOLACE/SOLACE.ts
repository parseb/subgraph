...
export class GovernanceLocked extends ethereum.Event {
  get params(): GovernanceLocked__Params {
    return new GovernanceLocked__Params(this);
  }
}

export class GovernanceLocked__Params {
  _event: GovernanceLocked;

  constructor(event: GovernanceLocked) {
    this._event = event;
  }
}
...
export class SOLACE extends ethereum.SmartContract {
  static bind(address: Address): SOLACE {
    return new SOLACE("SOLACE", address);
  }
  ...
  governanceIsLocked(): boolean {
    let result = super.call(
      "governanceIsLocked",
      "governanceIsLocked():(bool)",
      []
    );
  ...
  try_governanceIsLocked(): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "governanceIsLocked",
      "governanceIsLocked():(bool)",
      []
...
export class LockGovernanceCall extends ethereum.Call {
  get inputs(): LockGovernanceCall__Inputs {
    return new LockGovernanceCall__Inputs(this);
  }

  get outputs(): LockGovernanceCall__Outputs {
    return new LockGovernanceCall__Outputs(this);
  }
}

export class LockGovernanceCall__Inputs {
  _call: LockGovernanceCall;

  constructor(call: LockGovernanceCall) {
    this._call = call;
  }
}

export class LockGovernanceCall__Outputs {
  _call: LockGovernanceCall;
...
export class SetPendingGovernanceCall extends ethereum.Call {
  get inputs(): SetPendingGovernanceCall__Inputs {
    return new SetPendingGovernanceCall__Inputs(this);
  }

  get outputs(): SetPendingGovernanceCall__Outputs {
    return new SetPendingGovernanceCall__Outputs(this);
  }
}

export class SetPendingGovernanceCall__Inputs {
  _call: SetPendingGovernanceCall;

  constructor(call: SetPendingGovernanceCall) {
    this._call = call;
  }

  get pendingGovernance_(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetPendingGovernanceCall__Outputs {
  _call: SetPendingGovernanceCall;
